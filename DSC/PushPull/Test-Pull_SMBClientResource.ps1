$smbPullShare = "\\mark-vm\DSCConfig\SMBPull" # Standard SMB share. Same as on client LCM
...
Move-Item -Path "$(Join-Path $configPath $computerNames).mof" -Destination "$(Join-Path $smbPullShare ef4e3f76-6da5-4c0e-8a6c-7978ac85acc5.mof)" -Force
...
New-DscChecksum "$(Join-Path $smbPullShare ef4e3f76-6da5-4c0e-8a6c-7978ac85acc5.mof)" -Force # Force to update checksum
