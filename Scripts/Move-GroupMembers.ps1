$OldGroupsOULDAP = "LDAP://OU=Test,OU=KMD,OU=Brugere,OU=Butik,DC=triostaging,DC=local"
...
$oldGroupsOU = New-Object System.DirectoryServices.DirectoryEntry($OldGroupsOULDAP)
